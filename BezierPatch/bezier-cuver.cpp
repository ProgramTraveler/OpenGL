///////////////////////////////////////////////////////////////////////////////////////
////画一条Bezier曲线，采用三种方法：Bernstein基函数、deCasteljua递推算法和OpenGL函数
//操作：鼠标确定四个控制点,鼠标右键弹出菜单选，择绘制方式
//键C：清屏、键e：清除曲线，保留控制点，重画曲线
///////////////////////////////////////////////////////////////////////////////////////
#include <GL/glut.h>
#include <cmath>
#include <iostream>
...
void  display()
{
	...
	drawPoint(); // draw control points after remove a curve
	glColor3f(1.0, 1.0, 1.0);
	glLineWidth(1);
	glBegin(GL_LINE_LOOP);  //draw a rectangle
	glVertex2f(-9.5, -9.5);
	glVertex2f(9.5, -9.5);
	glVertex2f(9.5, 9.5);
	glVertex2f(-9.5, 9.5);
...
void processMenu(int value)
{
	...
	{
	case 1:
		drawBezier_Bernstein();
		break;
	case 2:
		drawBeizer_deCasteljau();
		break;
	case 3:
		drawBezier_OpenGL();
		break;
